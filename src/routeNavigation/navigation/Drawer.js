...
import SecurityListScreen from '../../screens/dashboardUser/SecurityListScreen';
     ...
     <Drawer.Screen name="Booking"
      options={{
        ...
        <Pressable onPress={()=>props.navigation.navigate('BottomTab')} >
          <Image source={AppImage.back} style={{marginLeft:10}}/>
        </Pressable>
        ),
    }}
       ...
       component={AboutScreen} />
         ...
         <Drawer.Screen name="PrivacySecurity"
        options={{
          headerShown:false
        }}
       component={PrivacySecurityScreen} />
     
     <Drawer.Screen name="TermCondition"
        options={{
          headerShown:false
        }}
       component={TermConditionScreen} />
     <Drawer.Screen name="Step3" 
        options={{
          headerShown:false
        }}
